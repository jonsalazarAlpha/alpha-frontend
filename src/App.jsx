          ...
          <div style={{ background: '#f8f9fa', borderRadius: 10, padding: '16px 20px', marginBottom: 24 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
              ...
              <div>
                ...
                <input name="marca" placeholder="Toyota, Kia, Ford..." onChange={inp} style={inputStyle} />
              </div>
              <div>
                <label style={labelStyle}>Modelo *</label>
                <input name="modelo" placeholder="Corolla, Rio, Ranger..." onChange={inp} style={inputStyle} />
              </div>
              <div>
              ...
              <div>
                ...
                <input name="color" placeholder="Blanco, Negro, Gris..." onChange={inp} style={inputStyle} />
              </div>
              <div>
